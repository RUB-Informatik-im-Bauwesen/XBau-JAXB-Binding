...
/**
 * Dieser Code-Typ steht für die Zuschläge, die bei der Berechnung der anrechenbaren Bauwerte zu berücksichtigen sind, gemäß zutreffender Verordnung für die Prüfingenieure und Prüfsachverständige. 
 * 
 ...
 * 
 * <p>Java-Klasse für Code.BauwerteZuschlaegePPVO complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="Code.BauwerteZuschlaegePPVO">
 *   &lt;complexContent>
...
@XmlType(name = "Code.BauwerteZuschlaegePPVO")
public class CodeBauwerteZuschlaegePPVO
    extends Code
{
