...
/**
 * Arten von technischen Anlagen, die der Überwachungspflicht unterliegen gemäß Musterprüfverordnung §2 Abs. 1
 * 
 ...
 * 
 * Als Muster wurde die Codeliste XBau Technische Anlagen gemäß M-PPVO (URI: urn:xoev-de:xbau:codeliste:mppvotechnischeanlage) als Angebot zur Einbindung für diesen Typ  bereitgestellt. 
 * 
 ...
 * 
 * <p>Java-Klasse für Code.MppvoTechnischeAnlage complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="Code.MppvoTechnischeAnlage">
 *   &lt;complexContent>
...
@XmlType(name = "Code.MppvoTechnischeAnlage")
public class CodeMppvoTechnischeAnlage
    extends Code
{
