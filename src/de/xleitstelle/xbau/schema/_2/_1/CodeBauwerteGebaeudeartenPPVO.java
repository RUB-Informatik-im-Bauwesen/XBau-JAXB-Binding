...
/**
 * Dieser Code-Typ steht für die Gebäudearten mit den entsprechenden relativen Bauwerten gemäß zutreffender Verordnung für die Prüfingenieure und Prüfsachverständige. Diese Gebäudearten werden für die Berechnung von Gebühren verwendet.
 * 
 ...
 * 
 * <p>Java-Klasse für Code.BauwerteGebaeudeartenPPVO complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="Code.BauwerteGebaeudeartenPPVO">
 *   &lt;complexContent>
...
@XmlType(name = "Code.BauwerteGebaeudeartenPPVO")
public class CodeBauwerteGebaeudeartenPPVO
    extends Code
{
